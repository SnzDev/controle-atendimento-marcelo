...
function Region() {
  ...
  const list = api.region.getAll.useQuery({ name: nameDebounced });
  const inactive = api.region.inativate.useMutation({
    onSuccess: () => {
      void queryCtx.region.getAll.invalidate();
      void Swal.fire({
        icon: "success",
        title: "Região inativada com sucesso!",
    ...
    onError: () => {
      void Swal.fire({
        icon: "error",
        title: "Falha ao inativar a região!",
  ...
  const active = api.region.activate.useMutation({
    onSuccess: () => {
      void queryCtx.region.getAll.invalidate();
      void Swal.fire({
        icon: "success",
        title: "Região ativada com sucesso!",
        showConfirmButton: false,
        timer: 1500,
      });
    },
    onError: () => {
      void Swal.fire({
        icon: "error",
        title: "Falha ao ativar a região!",
        text: "Algo deu errado",
        showConfirmButton: false,
        timer: 1500,
      });
  ...
  return (
    <>
      <Head>
        <title>Cadastro de a região</title>
        <meta name="description" content="Cadastro de a região" />
...
const ModalCreate = ({ clientId, isOpen, onClose }: ModalCreateProps) => {
  ...
  const create = api.region.create.useMutation({
    onSuccess: () => {
      void queryCtx.region.getAll.invalidate();
      void Swal.fire({
        icon: "success",
        title: "Região cadastrado com sucesso!",
        showConfirmButton: false,
        timer: 1500,
      });
      reset();
    ...
    onError: () => {
      void Swal.fire({
        icon: "error",
        title: "Falha ao cadastrar a região!",
        text: "Algo deu errado",
        showConfirmButton: false,
        timer: 1500,
      });
  ...
  const update = api.region.update.useMutation({
    onSuccess: () => {
      void queryCtx.region.getAll.invalidate();
      void Swal.fire({
        icon: "success",
        title: "Região atualizado com sucesso!",
        showConfirmButton: false,
        timer: 1500,
      });
      reset();
    ...
    onError: () => {
      void Swal.fire({
        icon: "error",
        title: "Falha ao editar a região!",
        text: "Algo deu errado",
        showConfirmButton: false,
        timer: 1500,
      });
