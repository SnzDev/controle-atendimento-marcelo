...
export const getServerSideProps = async (
  ...
  if (session) {
    return { redirect: { destination: "/whatsapp/atendimentos" } };
  }
  return {
...
export default function Login() {
  return (
    <main className="flex h-screen w-screen flex-col justify-center overflow-hidden">
      <div className="flex h-full w-full items-center justify-between">
        <aside className="flex h-screen w-1/2 flex-col justify-end rounded-r-3xl bg-login-aside bg-cover bg-center">
        </aside>
